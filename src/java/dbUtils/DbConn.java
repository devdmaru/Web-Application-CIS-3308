    ...
    public DbConn() {
        ...
        try {
            ...
            try {
                ...
                String url = "jdbc:mysql://localhost:3307/sp17_3308_tuf37373?user=tuf37373&password=eezibiej";

                // unless you are working from temple (wachman hall)
                if (this.isTemple()) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/sp17_3308_tuf37373?user=tuf37373&password=eezibiej";
                }
